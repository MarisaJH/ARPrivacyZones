...
namespace GoogleARCore.Examples.Common
{
    ...
    public class DetectedPlaneGenerator : MonoBehaviour
    {
        ...
        //public GameObject DetectedPlanePrefabTransparent;
        ...
        //private List<DetectedPlane> m_TransparentPlanes = new List<DetectedPlane>();
        ...
        public void Update()
        {
            ...
            for (int i = 0; i < m_NewPlanes.Count; i++)
            {
                ...
                /*
                GameObject planeObjectTransparent =
                    Instantiate(DetectedPlanePrefabTransparent, Vector3.zero, Quaternion.identity, transform);
                planeObjectTransparent.GetComponent<DetectedPlaneVisualizer>().Initialize(m_TransparentPlanes[i]);
                */
            }
        }
    }
